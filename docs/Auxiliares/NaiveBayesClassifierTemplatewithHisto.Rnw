...
Los cuantiles calculados con base en el modelo ajustado, para ser considerados son 
<<echo = FALSE>>=
print(CuantilesD)
@
...
<<echo = FALSE, fig=TRUE>>=
ggplot(data=ExpBasal,aes(Log2Basal,
                         fill=Categoria,
                         color=Categoria))+
  geom_histogram(binwidth = 0.5, 
                 position = "dodge")+ theme(legend.position="right")+
...
ggplot(data=ExpBasal,
  ...
  theme_classic()+scale_fill_brewer(7,palette="Dark2")+
  labs(title="Expresion Basal Normalizada",
       x="Categoria por Expresion Basal (Log2)",
       y = "Frecuencia")
# <> <> <> <> <> <> <> <> <> <> <> <> <> <> <> <> <> <>
...
#===========================================================================
ggplot(data=ExpBasal,aes(Log2Basal,color=Categoria))+geom_histogram(binwidth = 0.15, bins = 25,
                                                                    fill='white',
                                                                    position = "dodge",
                                                                    linetype = "dashed")
@
...
ggplot(data=ExpBasal,aes(Log2Basal,fill=Categoria,color=Categoria))+
  geom_histogram(binwidth = tambinwidth, bins = numbins,position = "dodge")+
  theme(legend.position="right")+
  labs(title="Expresion Basal Normalizada",x="Categoria por Expresion Basal (Log2)", y = "Frecuencia")
# - - - - - - - -  - - - - - - - -  - - - - - - - -  - - - - - - - -  - - - - - - - -  - - - - - - - - 
@
