...
Recordemos que se traslado una unidad para que los datos fuesen positivos y así poder
...
#===========================================================================
abline(v=CuantilesA[1,1], lty=2, col="darkgoldenrod4"); abline(v=CuantilesA[1,2], lty=2, col="darkgoldenrod4")
abline(v=CuantilesA[2,1], lty=2, col="darkblue"); abline(v=CuantilesA[2,2], lty=2, col="darkblue")
abline(v=CuantilesA[3,1], lty=2, col="aquamarine4"); abline(v=CuantilesA[3,2], lty=2, col="aquamarine4")
abline(v=CuantilesA[4,1], lty=2, col="green"); abline(v=CuantilesA[4,2], lty=2, col="green")
abline(v=CuantilesA[5,1], lty=2, col="brown"); abline(v=CuantilesA[5,2], lty=2, col="brown")
abline(v=CuantilesA[6,1], lty=2, col="red"); abline(v=CuantilesA[6,2], lty=2, col="red")
abline(v=CuantilesA[7,1], lty=2, col="blue"); abline(v=CuantilesA[7,2], lty=2, col="blue")
abline(v=CuantilesA[8,1], lty=2, col="orange"); abline(v=CuantilesA[8,2], lty=2, col="orange")
legend("topright",
       legend=c("65%",
                "70%",
                "75%",
...
\begin{itemize}
\item Very Low Expression: $\left[-\infty,0.1435432\right)$,
\item Moderately Low Expression: $\left[0.143542,0.7410834\right)$,
\item Moderate Expresion: $\left[0.7410834,6.104588\right)$,
\item Moderately High Expression: $\left[6.104588,7.490593\right)$,
\item Very High Expression: $\left[7.490593,\infty\right)$.
\end{itemize}
...
tt1 <- min(tt)
VLI <- tt1
VLS <- CuantilesA[5,1] - 0.0000001
MLI <- CuantilesA[5,1]
MLS <- CuantilesA[2,1] - 0.0000001
MI  <- CuantilesA[2,1]
MS  <- CuantilesA[2,2] - 0.0000001
MHI <- CuantilesA[2,2]
MHS <- CuantilesA[5,2] - 0.0000001
VHI <- CuantilesA[5,2]
VHS <- max(tt)
...
$P\left[LB|C_{i}\right]$&0.08108108&0.04568528&0.11538462&0.09582310\\
$P\left[LMB|C_{i}\right]$&0.02702703&0.04568528&0.05769231&0.04176904\\
$P\left[MB|C_{i}\right]$&0.7837838&0.7665975&0.6346154&0.7272727\\
$P\left[HMB|C_{i}\right]$&0.02702703&0.04568528&0.07692308&0.06879607\\
$P\left[HB|C_{i}\right]$&0.08108108&0.09644670&0.11538462&0.06633907\\\hline\hline
$P\left[C_{i}\right]$&0.05339105&0.28427128&0.07503608&0.058730159\\\hline\hline
$P\left[LB|C_{i}\right]P\left[C_{i}\right]$&0.004329004&0.01298701&0.008658009&0.05627706\\
$P\left[LMB|C_{i}\right]P\left[C_{i}\right]$&0.001443001&0.01298701&0.004329004&0.02453102\\
$P\left[MB|C_{i}\right]P\left[C_{i}\right]$&0.041847042&0.21789322&0.047619048&0.42712843\\
$P\left[HMB|C_{i}\right]P\left[C_{i}\right]$&0.001443001&0.01298701&0.005772006&0.04040404\\
$P\left[HB|C_{i}\right]P\left[C_{i}\right]$&0.004329004&0.02741703&0.008658009&0.03896104\\\hline\hline
$\sum_{i=1}^{4}P\left[LB|C_{i}\right]P\left[C_{i}\right]$&0.08225108&&&\\
$\sum_{i=1}^{4}P\left[LMB|C_{i}\right]P\left[C_{i}\right]$&0.04329004&&&\\
$\sum_{i=1}^{4}P\left[MB|C_{i}\right]P\left[C_{i}\right]$&0.73448773&&&\\
$\sum_{i=1}^{4}P\left[HMB|C_{i}\right]P\left[C_{i}\right]$&0.06060606&&&\\
$\sum_{i=1}^{4}P\left[HB|C_{i}\right]P\left[C_{i}\right]$&0.07936508&&&\\\hline\hline
$P\left[C_{i}|LB\right]=\frac{P\left[LB|C_{i}\right]P\left[C_{i}\right]}{\sum_{i=1}^{4}P\left[LB|C_{i}\right]P\left[C_{i}\right]}$&0.05263158&0.1578947&0.10526316&0.6842105\\
$P\left[C_{i}|LMB\right]=\frac{P\left[LMB|C_{i}\right]P\left[C_{i}\right]}{\sum_{i=1}^{4}P\left[LMB|C_{i}\right]P\left[C_{i}\right]}$&0.03333333&0.30000000&0.10000000&0.5666667\\
$P\left[C_{i}|MB\right]=\frac{P\left[MB|C_{i}\right]P\left[C_{i}\right]}{\sum_{i=1}^{4}P\left[MB|C_{i}\right]P\left[C_{i}\right]}$&0.05697446&0.2966601&0.06483301&0.5815324\\
$P\left[C_{i}|HMB\right]=\frac{P\left[HMB|C_{i}\right]P\left[C_{i}\right]}{\sum_{i=1}^{4}P\left[HMB|C_{i}\right]P\left[C_{i}\right]}$&0.02380952&0.2142857&0.09523810&0.66666667\\
$P\left[C_{i}|HB\right]=\frac{P\left[HB|C_{i}\right]P\left[C_{i}\right]}{\sum_{i=1}^{4}P\left[HB|C_{i}\right]P\left[C_{i}\right]}$&0.05454545&0.3454545&0.10909091&0.4909091\\\hline\hline
\end{tabular}}
...
$Prob\left[\cdot\right]$&0.08225108&0.04329004&0.7344877&0.06060606&0.07936508\\\hline\hline
\end{tabular}}
