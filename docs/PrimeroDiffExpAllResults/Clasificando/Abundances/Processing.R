...
#----------------------------------------------------------------------
log2sample1 <- log2(sample1);         log2sample2 <- log2(sample2)
log2sample3 <- log2(sample3);         log2samplevsCmasM1 <- log2(samplevs1)
log2samplevsCmasM2 <- log2(samplevs2); log2samplevsCmasM3 <- log2(samplevs3)
data2 <- cbind(data2, log2sample1,log2sample2,log2sample3,
               log2samplevsCmasM1,log2samplevsCmasM2,log2samplevsCmasM3)
View(data2)
#<<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>>
data3 <- pEhExvsEhMyb10;       View(data3)
...
#----------------------------------------------------------------------
log2sample1 <- log2(sample1);         log2sample2 <- log2(sample2)
log2sample3 <- log2(sample3);         log2samplevsEhMyb101 <- log2(samplevs1)
log2samplevsEhMyb102 <- log2(samplevs2);     log2samplevsEhMyb103 <- log2(samplevs3)
data3 <- cbind(data3, log2sample1,log2sample2,log2sample3,
               log2samplevsEhMyb101,log2samplevsEhMyb102,log2samplevsEhMyb103)
View(data3)
#<<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>>
data4 <- pEhExvsU2AF84;       View(data4)
...
#----------------------------------------------------------------------
log2sample1 <- log2(sample1);         log2sample2 <- log2(sample2)
log2sample3 <- log2(sample3);         log2samplevsU2AF841 <- log2(samplevs1)
log2samplevsU2AF842 <- log2(samplevs2);     log2samplevsU2AF843 <- log2(samplevs3)
data4 <- cbind(data4, log2sample1,log2sample2,log2sample3,
               log2samplevsU2AF841,log2samplevsU2AF842,log2samplevsU2AF843)
View(data4)
#<<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>><<==>>
data5 <- pEhExvsUmasM;       View(data5)
...
#----------------------------------------------------------------------
log2sample1 <- log2(sample1);         log2sample2 <- log2(sample2)
log2sample3 <- log2(sample3);         log2samplevsUmasM1 <- log2(samplevs1)
log2samplevsUmasM2 <- log2(samplevs2);     log2samplevsUmasM3 <- log2(samplevs3)
...
hist(log2sample1, breaks = nbreaks, col= rainbow(25,0.3), 
     main = 'Log2 sample1')
meanlog2sample1 <- mean(log2sample1)
StdDevlog2sample1 <- sd(log2sample1)
Normlog2sample1 <- (log2sample1-meanlog2sample1)/StdDevlog2sample1
tst<- Normlog2sample1
hist(tst, breaks = nbreaks, col= 1:5, 
     main = 'Normalized Log2sample1',
     xlab='pEhEx1',
     ylab= 'Frequency pEhExvs1')
#----------------------------------------------------------------------
...
hist(tst, breaks = nbreaks, col= rainbow(1,0.7),
     main = 'Normalized Log2 pEhExvs1 - DATA', lty=9)
#===========================================================================
...
hist(tst, breaks = nbreaks, col= rainbow(1,0.7),
     main = 'Normalized Log2   pEhExvs1 - ADJUSTED', lty=9)
#----------------------------------------------------------------------
